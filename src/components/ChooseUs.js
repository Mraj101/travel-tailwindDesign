    ...
    <div className="md:p-12">
      <div className="flex flex-col items-center justify-center gap-10 text-center">
        <div className="flex flex-col items-center justify-center gap-3">
          <h1 className="text-black text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-bold">Why Choose us</h1>
        ...
        <div className="flex flex-col items-center justify-center md:flex-row gap-10">
          <div className="border shadow-sm shadow-100 p-3 md:w-1/2 flex items-start flex-col gap-3">
            <img src={HotelImg} alt="img" className=" w-16 md:w-20"/>
          ...
          <div className=" border shadow-sm p-3 md:w-1/2 flex items-start flex-col gap-3">
          <img src={MapImg} alt="img" className="w-16 md:w-20"/>
            <h1 className="text-black text-xl font-bold text-start">HandPicked Hotels</h1>
            <p className="text-black text-start">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores
              dolor ducimus, rem corrupti architecto totam omnis quibusdam non
        ...
        <div className="border shadow-sm p-3 md:w-1/2 flex items-start flex-col gap-3">
        <img src={TagImg} alt="img" className="w-16 md:w-20"/>
            <h1 className="text-black text-xl font-bold text-start">HandPicked Hotels</h1>
            <p className="text-black text-start">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores
            dolor ducimus, rem corrupti architecto totam omnis quibusdam non
