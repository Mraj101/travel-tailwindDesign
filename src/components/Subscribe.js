...
const Subscribe = () => {
  return (
    <div className="flex items-center justify-center p-12 font-mulish">
    <div className="flex justify-between w-full">
      <div className="flex flex-col justify-center w-[44%]  gap-4 border shadow-lg border-orange-500 rounded-xl p-6">
